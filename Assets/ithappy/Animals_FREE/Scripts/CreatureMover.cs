...
namespace Controller
{
    ...
    public class CreatureMover : MonoBehaviour
    {
        ...
        private void OnValidate()
        {
            ...
            m_Movement?.SetStats(m_WalkSpeed / 3.6f, m_RunSpeed / 3.6f, m_RotateSpeed);
        }
        ...
        private void Awake()
        {
            ...
            m_Movement = new MovementHandler(m_Controller, m_Transform, m_WalkSpeed, m_RunSpeed, m_RotateSpeed);
        ...
        private class MovementHandler
        {
            ...
            public MovementHandler(CharacterController controller, Transform transform, float walkSpeed, float runSpeed, float rotateSpeed)
            {
            ...
            public void Move(float deltaTime, in Vector2 axis, in Vector3 target, bool isRun, bool isMoving, out Vector2 animAxis, out bool isAir)
            {
                ...
                ConvertMovement(in axis, in movementForward, out var movement);
